...
<i18n lang="json">
{
  "en": {
    ...
    "subject": "Subject",
    "html_body": "HTML Body",
    "html_body_description": "Use {variable} for placeholders. Available variables are shown below.",
  ...
  "de": {
    ...
    "html_body_description": "Verwende {variable} für Platzhalter. Verfügbare Variablen werden unten angezeigt.",
